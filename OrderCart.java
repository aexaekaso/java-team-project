...
//			products.add(selectProduct);
	...
	public void orderCartShow() { // 2. 장바구니 입력했을 때
		...
		System.out.println("==================================================");
		System.out.format("+--------+---------------------------+--------+--------+\n");
		System.out.printf("| %-4s | %-23s | %-4s | %-4s |\n", "번호", "메뉴", "수량", "가격");
		System.out.format("+--------+---------------------------+--------+--------+\n");
		int no = 0;
		String menu = "";
		int amount1 = 0;
		...
		for (int i = 0; i < amount.size(); i++) {
			...
			System.out.printf("| %-6d | %-" + pf.convertByte(25, menu) + "s | %6d | %6d |\n", no, menu, amount1, price);
//			System.out.printf("| %-5d | %-15s | %-6d | %-6d |\n", no, menu, amount1, price);
	...
	public static void bill() { // 영수증
		...
		for (int i = 0; i < amount.size(); i++) {
			...
			System.out.printf("| %-6d | %-" + pf.convertByte(25, mene) + "s | %6d | %6d |\n", no, mene, amount1, price);
//			System.out.printf("| %-5d | %-15s | %-6d | %-6d |\n", no, mene, amount1, price);
		}
		System.out.format("+--------+---------------------------+--------+--------+\n");
		System.out.println("총 가격 >> " + billPrice + "\n");
