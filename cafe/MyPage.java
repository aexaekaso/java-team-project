...
public class MyPage {
	...
	public void viewMyInfo() {
		...
		try {
			...
			if (db.RS.next() == true) {
				String printFormat = "| %-"+ pf.convertByte(10, db.RS.getString("customer_name")) + "s | %-15s | %-15s | %6s | %9s |\n";
				System.out.format("+------------+-----------------+-----------------+--------+-----------+\n");
				System.out.printf("| %-8s | %-12s | %-11s | %4s | %6s |\n", "이름", "아이디", "전화번호", "쿠폰", "스탬프");
				System.out.format("+------------+-----------------+-----------------+--------+-----------+\n");
	...
	public void orderList() {
		try {
			...
			System.out.println("\n==================================================");
			System.out.println("* 내 주문 내역");
			System.out.println("==================================================");
			
			System.out.format("+---------------------------+--------+--------+------------+\n");
			System.out.printf("| %-23s | %-4s | %-4s | %-8s |\n", "메뉴", "수량", "가격", "날짜");
			System.out.format("+---------------------------+--------+--------+------------+\n");			
//			System.out.println("    메뉴   / 수량/ 가격 / 결제시간");
			while(db.RS.next()) {
				String format = "| %-" + pf.convertByte(25, db.RS.getString("oname")) + "s | %6s | %6s | %-10s |\n";
				System.out.printf(format, db.RS.getString("oname"), db.RS.getInt("oamount"), db.RS.getInt("oprice"), new Date(db.RS.getTimestamp(4).getTime()));
